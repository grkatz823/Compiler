...
var scopeTree = function() {
    ...
    //********************************************
    t.addBranchNode = function(name,symbolTable) {
	// variable name refers to the scopeNumber of the Node    
        // Construct the node object.
        var node = {name: name, symbolTable,children: [], parent: {}};
    ...
    //******************************
    t.addLeafNode = function(name,symbolTable) {
        // Construct the node object.
        var node = {name: name, symbolTable, children: [], parent: {}};
